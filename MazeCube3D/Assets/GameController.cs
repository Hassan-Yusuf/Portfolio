...
public class GameController: MonoBehaviour
{
    ...
    public IEnumerator startDelay()
    {
        ...
        tutorialText.text = "Move the direction the cube is facing with the LEFT and RIGHT arrow keys";
        yield return new WaitForSeconds(5);
        playerRB.isKinematic = false;
        tutorialText.text = "Move the cube forwards and backwards with the UP and DOWN arrow keys";
        yield return new WaitForSeconds(5);
        tutorialText.text = "";
    }
        void Update()
